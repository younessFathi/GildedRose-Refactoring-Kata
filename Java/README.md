...
Les Test unitaires:
	...
	-Si la "Quality value" s'augmante par 2 si "Sellin value" <= à 10.
	-Si la "Quality value" s'augmante par 3 si "Sellin value" <= à 5.
	-Si la "Quality value" egale à 0 si "Sellin value" egale 0.
	-- new feature test
